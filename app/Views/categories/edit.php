<?php use App\Core\View; View::layout('app'); $title = 'Edit Category'; ?>
...
<div class="page-header" style="margin-bottom:1.75rem;">
    <div>
        ...
        <p class="page-subtitle">Modify the details of category: <strong><?= esc($category['name']) ?></strong></p>
    </div>
</div>
    ...
    <div class="pf-form-main" style="flex: 1;">
        <div class="card" style="background:#fff; border:1px solid var(--border); border-radius:16px; overflow:hidden;">
            <div class="card-header" style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border); display:flex; justify-content:space-between; align-items:center;">
                <span class="card-title" style="font-weight:700; color:var(--text-heading);">Edit Category Information</span>
            ...
            <div style="padding:1.5rem;">
                <form method="POST" action="/categories/<?= (int)$category['id'] ?>">
                    ...
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        ...
                        <input type="text" name="name" class="form-input" placeholder="e.g. Analgesics, Antibiotics" value="<?= esc(old('name', $category['name'])) ?>" required style="width:100%; padding:0.65rem 0.85rem; border:1px solid var(--border); border-radius:8px; font-size:0.9rem; background:#fff; color:var(--text-body);" autofocus>
                    </div>
        ...
        <div class="card" style="background:#fff; border:1px solid var(--border); border-radius:16px; overflow:hidden;">
            ...
            <div style="padding:1.25rem;">
                <ul class="pf-tips-list" style="list-style:none; padding:0; margin:0; display:flex; flex-direction:column; gap:0.75rem; font-size:0.825rem; color:var(--text-muted); line-height:1.4;">
                    <li><i class="bi bi-lightbulb" style="color:var(--accent-orange); margin-right:0.35rem;"></i> Renaming a category updates the category name globally for all associated medicines immediately.</li>
                    <li><i class="bi bi-shield-check" style="color:#22c55e; margin-right:0.35rem;"></i> The name must remain unique in the system.</li>
                </ul>
            </div>
        </div>
    </div>
